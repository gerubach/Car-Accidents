...
The file example.png is a picture of a sample run of the app. If you would like to run the app yourself, you must have R and R Shiny installed and download all the files and put them all in a folder named "R" (no quotes). Then run app.R.
